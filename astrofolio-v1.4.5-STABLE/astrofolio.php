...
class AstroFolio_Safe {
    ...
    public function init() {
        if (is_admin()) {
            ...
            // AJAX pour la récupération d'images
        ...
        add_shortcode('astrofolio_gallery', array($this, 'gallery_shortcode')); // Rétrocompatibilité
        add_shortcode('astro_image', array($this, 'image_shortcode'));
        add_shortcode('astro_object', array($this, 'object_shortcode'));
        
        // Helper de test pour debug (seulement pour les admins)
        ...
        add_shortcode('astro_test_recovery', array($this, 'test_recovery_shortcode')); // Shortcode de test
        add_shortcode('astro_simple_test', array($this, 'simple_test_shortcode')); // Test ultra-simple
        ...
        // Masquer les images AstroFolio de la bibliothèque WordPress
        ...
        // Enregistrer les actions AJAX pour l'autocomplétion
        add_action('wp_ajax_search_catalog_objects', array($this, 'ajax_search_catalog_objects'));
        add_action('wp_ajax_get_object_cross_references', array($this, 'ajax_get_object_cross_references'));
