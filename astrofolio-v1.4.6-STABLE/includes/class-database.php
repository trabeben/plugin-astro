...
/**
 * =============================================================================
 * CLASSE DE GESTION DE LA BASE DE DONNÉES ASTROFOLIO
 * =============================================================================
 * 
 * Cette classe centralise toutes les opérations de base de données pour AstroFolio
 * 
 * 🗄️ TABLES GÉRÉES :
 * - astro_objects : Objets astronomiques avec métadonnées complètes
 * - astro_catalogs : Catalogues astronomiques (NGC, IC, Messier, etc.)
 * - astro_cross_references : Références croisées entre catalogues
 * - astro_equipment : Équipements utilisés pour les photos
 * - astro_metadata : Métadonnées techniques des images
 * 
 * 🔧 FONCTIONNALITÉS :
 * - Création et mise à jour automatique du schéma
 * - Migration de données lors des mises à jour
 * - Requêtes optimisées avec index appropriés
 * - Gestion des relations Foreign Key
 * - Outils de réparation et maintenance
 * 
 * 📊 PERFORMANCE :
 * - Index optimisés pour les recherches fréquentes
 * - Requêtes préparées pour éviter les injections SQL
 * - Cache des résultats pour les catalogues
...
class Astro_Database {
     ...
     * Utilisée pour les migrations automatiques
     * @var string
     */
