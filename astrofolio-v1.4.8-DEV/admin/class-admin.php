...
class Astro_Admin {
    ...
    public function add_admin_menu() {
        ...
        add_submenu_page(
            'astrofolio',                    // Menu parent
            '📤 Upload Groupé d\'Images',    // Titre de la page
            '📤 Upload Groupé',              // Texte du menu
            'edit_astro_images',            // Capacité personnalisée pour l'édition
            'astrofolio-upload-bulk',       // Slug unique
            array($this, 'upload_bulk_page') // Fonction de rendu
        );
    ...
    public function enqueue_admin_scripts($hook) {
        ...
        // NOUVEAU v1.4.7 : JavaScript pour l'upload groupé
        if ($hook === 'astrofolio_page_astrofolio-upload-bulk') {
            wp_enqueue_style(
                'astrofolio-bulk-upload',
                ANC_PLUGIN_URL . 'admin/css/bulk-upload.css',
                array('astrofolio-admin'),
                ANC_VERSION
            );
            ...
            wp_enqueue_script(
                'astrofolio-bulk-upload',
                ANC_PLUGIN_URL . 'admin/js/bulk-upload.js',
                array('jquery'),
                ANC_VERSION,
                true
            );
            
            // Variables JavaScript pour l'upload groupé
            wp_localize_script('astrofolio-bulk-upload', 'astroBulkUpload', array(
     ...
     * 
     * FONCTIONNALITÉS :
     * - Sélection multiple de fichiers (jusqu'à 20)
     * - Drag & drop pour faciliter l'usage
     * - Métadonnées communes appliquées à tous les fichiers
     * - Titres individualisables pour chaque fichier
            ...
            <div class="astro-bulk-upload-container">
                ...
                <form id="bulk-upload-form" class="bulk-upload-section" style="display: none;">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-field">
                            <label for="bulk_acquisition_date">Date d'acquisition</label>
                            <input type="date" id="bulk_acquisition_date" name="acquisition_date">
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-field">
                            <label for="bulk_total_exposure_time">Temps d'exposition total (min)</label>
                            <input type="number" id="bulk_total_exposure_time" name="total_exposure_time" 
                                min="0" step="0.1" placeholder="120">
                        </div>
                    </div>
                    
                    <!-- Champs techniques optionnels - repliables -->
                    <div class="form-field">
                        <h4 style="margin: 20px 0 10px 0;">
                            <button type="button" id="toggle-technical-fields" class="button-link" style="text-decoration: none;">
                        ...
                        <div id="technical-fields" style="display: none;">
                            <div class="form-row">
                                <div class="form-field">
                                    <label for="bulk_focal_length">Distance focale (mm)</label>
                                    <input type="number" id="bulk_focal_length" name="focal_length" 
                                        min="0" step="0.1" placeholder="800">
                                </div>
                                
                                <div class="form-field">
                                    <label for="bulk_f_number">Rapport F/D</label>
                                    <input type="text" id="bulk_f_number" name="f_number" 
                                        placeholder="f/6.3">
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                <div class="form-field">
                                    <label for="bulk_filter_type">Filtre</label>
                                    <input type="text" id="bulk_filter_type" name="filter_type" 
                                        placeholder="L-Pro, UHC, OIII...">
                                </div>
                                
                                <div class="form-field">
                                    <label for="bulk_iso_value">ISO</label>
                                    <input type="number" id="bulk_iso_value" name="iso_value" 
                                        min="50" max="51200" placeholder="1600">
                                </div>
                            </div>
                        </div>
                    </div>
